...
public class guiEmpresa extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel7.setText("Lista de Empresas");
    ...
    private void botaogravarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botaogravarActionPerformed
        ...
        Empresa a = new Empresa(txtnome.getText(),txtcnpj.getText());
        dao.daoEmpresa.adicionar(a);
        System.out.println(dao.daoEmpresa.getEmpresas().toString());
        listaempresas.setListData (dao.daoEmpresa.getEmpresas().toArray());
    }//GEN-LAST:event_botaogravarActionPerformed

    private void botaoremoverActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botaoremoverActionPerformed
      Empresa a = (Empresa) listaempresas.getSelectedValue();
        
        dao.daoEmpresa.remover(a);
    ...
    private javax.swing.JList listaempresas;
